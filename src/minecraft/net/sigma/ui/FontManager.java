...
public class FontManager {
	...
	*/
	...
	public static TTFFontRenderer getSizedFont(String name, float size) {
	...
	public static TTFFontRenderer getFontQualityAndSize(String name, float quality, float size) {
		return new TTFFontRenderer(name, 0, size, 0, quality);
	} 
