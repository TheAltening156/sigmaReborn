...
public class ScreenChatOptions extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(2022, this.width / 2 - 155, this.height / 6 + 120, 310, 20, ""));

        this.buttonList.add(new GuiButton(200, this.width / 2 - 100, this.height / 6 + 155, I18n.format("gui.done", new Object[0])));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        boolean hovered = mouseX >= this.width / 2 - 155 && mouseY >= this.height / 6 + 120 && mouseX <= this.width / 2 + 155 && mouseY <= this.height / 6 + 120 + 20;
        this.drawCenteredString(this.fontRendererObj, "Chat Background : " + (Sigma.back ? "ON" : "OFF" /*"Enabled" : "Disabled"*/), (this.width / 2), (this.height / 6 + 126), hovered ? 16777120 : -1);
        //drawRect(this.width / 2 - 155, this.height / 6 + 120, this.width / 2 + 155, this.height / 6 + 120 + 20, -1);
    }
}
