...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    {
    	AsyncVersionSlider v = ViaMCP.getInstance().asyncSlider;
    	if (v == null || v == ViaMCP.getInstance().asyncSlider) {
    		v = new AsyncVersionSlider(-1, width / 2 + 43, 10, Math.max(10, 118), 20);
    	}
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawString(fontRendererObj, I18n.format("multiplayer.title"), width / 2 - 150, 15, -1);
        this.drawCenteredString(fontRendererObj, EnumChatFormatting.GRAY + "Jello Portal:", width / 2, 15, -1);
