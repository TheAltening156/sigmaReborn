    ...
    protected void mouseDragged(Minecraft mc, int mouseX, int mouseY)
    {
        if (this.visible)
        {
            ...
            /*if (this.hovered) {
            	...
            	Gui.drawRect(this.xPosition + (sliderValue * this.width), this.yPosition, this.xPosition + 16.5f, this.yPosition + 0.8f, -1);
            	Gui.drawRect(this.xPosition + (sliderValue * this.width), this.yPosition, this.xPosition + 10.5f, this.yPosition + 19.5f, -1);
            	Gui.drawRect(this.xPosition + (sliderValue * this.width) + 7.5f, this.yPosition, this.xPosition + 15.8f, this.yPosition + 19.5f, -1);
            	Gui.drawRect(this.xPosition + (sliderValue * this.width), this.yPosition + 18.5f, this.xPosition + 16.8f, this.yPosition + 19.5f, -1);
