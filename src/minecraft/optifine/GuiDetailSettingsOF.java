...
public class GuiDetailSettingsOF extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(206969, this.width / 2 - 100, this.height / 6 + 128 + 11, ""));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        boolean hovered = mouseX >= this.width / 2 - 100 && mouseY >= this.height / 6 + 128 + 11 && mouseX <= this.width / 2 + 100 && mouseY <= this.height / 2 + 29;
        ...
        //Gui.drawRect(this.width / 2 - 100, this.height / 6 + 128 + 11, this.width / 2 + 100, this.height / 2 + 29, -1);
        this.drawCenteredString(fontRendererObj, "Dark Background : " + (Sigma.back1 ? "Enabled" : "Disabled"), this.width / 2, this.height / 6 + 128 + 17, j);
